...
public class TerrablenderCompat {
    ...
    public static void setup(){
        ...
        for(Map.Entry<String, SurfaceRules.RuleSource> entry : vanillaBiomeRules.entrySet()){
            terrablender.api.SurfaceRuleManager.addToDefaultSurfaceRulesAtStage(terrablender.api.SurfaceRuleManager.RuleCategory.OVERWORLD, SurfaceRuleManager.RuleStage.BEFORE_BEDROCK, 0, entry.getValue());
        }
