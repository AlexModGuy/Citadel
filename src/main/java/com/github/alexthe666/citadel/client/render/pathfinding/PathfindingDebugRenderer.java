...
public class PathfindingDebugRenderer {
    ...
    private static void debugDrawNode(final MNode n, final int argbColor, final WorldEventContext ctx) {
        ...
        if (n.parent != null) {
            ...
            buffer.addVertex(lineMatrix, 0.5f, 0.5f, 0.5f).color(0.75F, 0.75F, 0.75F, 1.0F);
            buffer.addVertex(lineMatrix, pdx / 0.25f, pdy / 0.25f, pdz / 0.25f).color(0.75F, 0.75F, 0.75F, 1.0F);
        }
